...
- [ ] **IMP-01**: User can import a JSON file via file picker
- [ ] **IMP-02**: App auto-detects the step container in arbitrary JSON (objects with `next`, `conditions`, or similar linking fields)
